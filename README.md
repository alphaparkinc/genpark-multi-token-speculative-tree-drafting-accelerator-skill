# genpark-multi-token-speculative-tree-drafting-accelerator-skill
...
> **GenPark AI Agent Skill** -- Multi-token speculative tree drafting accelerator (Medusa / Eagle style)
